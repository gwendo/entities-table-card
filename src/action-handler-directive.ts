...
customElements.define('action-handler-entities-table', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-entities-table')) {
    return body.querySelector('action-handler-entities-table') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-entities-table');
